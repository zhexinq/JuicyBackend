...
POST http://localhost:8080/juicyBackend/webapi/event/create
...
```json
{
    ...
    "imgFormat": "jpg",
    "creatorEmail": "bigbrother@cmu.edu",
    "name": "Big Event",
    "description": "This event is phenomenal",
    "lon": 20.5,
    "lat": 61.7,
    "imageContextColor": 4,
    "titleContextColor": 2
...
```json
{
    "imgUrl": "10.0.23.181:8080/juicyBackend/7.jpg",
    "titleContextColor": 2,
    "eventDateTime": "2015-11-27 11:25:51.0",
    "imageContextColor": 4,
    "creatorEmail": "bigbrother@cmu.edu",
...
POST http://localhost:8080/juicyBackend/webapi/event/join
...
POST http://localhost:8080/juicyBackend/webapi/event/disjoin
...
POST http://localhost:8080/juicyBackend/webapi/event/explore
